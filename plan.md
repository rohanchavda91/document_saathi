# Project Plan - Document Saathi

## Completed Tasks
- [x] **PDF Modification**: Save document photo into PDF instead of AI summary.
- [x] **Document Detail UI Enhancement**:
    - [x] Display Document Title and Scan Date clearly.
...
- [ ] Add more fields to Extracted Info (DOB, Address, etc. based on doc type).
- [ ] Improve PDF layout with branding and multiple images.
